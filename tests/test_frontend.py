...
class FrontendTest(unittest.TestCase):
    ...
    def test_frontend(self):
        ...
        self.assertIs(next_index_two, 0)
        self.assertEqual(len(front.instr_index), 2)
        ...
        cpu_bpu.update(2, False)
        front.add_instructions_to_queue()
        next_instr_three, next_index_three = front.pop_instruction_from_queue()
        front.add_instructions_to_queue()
        ...
        self.assertIs(next_index_three, 0)
        self.assertEqual(len(front.instr_index), 3)
        self.assertIs(front.instr_index[0], 1)
        self.assertIs(front.instr_index[1], 2)
        ...
        self.assertEqual(len(front.instr_index), 5)
        self.assertIs(front.instr_index[0], 1)
        self.assertIs(front.instr_index[1], 2)
        self.assertIs(front.instr_index[2], 3)
